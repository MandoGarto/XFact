...
const websitePackages = [
  ...
  },
  {
    ...
    features: [
      "Πλήρως responsive ιστοσελίδα",
      "Shop Setup WooCommerce / Custom σχεδίαση",
      "Πληρωμές μέσω Stripe / PayPal",
      "Products setup έως 25 προϊόντα",
      "Checkout & Cart",
      "Βασικό SEO",
      "Ταχύτητα φόρτωσης (βασική)",
      "Emails επιβεβαίωσης παραγγελίας",
    ],
    optionalAddons: [
      { name: "Multilingual", paid: true },
    ],
    cta: "Αγορά πακέτου",
    popular: false,
  },
  {
    name: "Flexible",
    price: "Custom",
    priceNote: "Τιμή κατόπιν συνεννόησης",
    features: [
      "Προσαρμοσμένη λύση στις ανάγκες σας",
      "Συνδυασμός υπηρεσιών & λειτουργιών",
      "Ευέλικτο πλάνο ανάπτυξης",
      "Προτεραιότητα υποστήριξης",
      "Scalable αρχιτεκτονική",
    ],
    optionalAddons: [],
